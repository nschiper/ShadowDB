...
signature LEXDEFS = sig
    ...
    exception BadCharacter    of string * string * Reg.region list
    ...
    exception BadAtomsClosing of string * Reg.region list

    val addLength    : int * int -> unit
    val getLength    : int -> int option
    val resetLengths : unit -> unit

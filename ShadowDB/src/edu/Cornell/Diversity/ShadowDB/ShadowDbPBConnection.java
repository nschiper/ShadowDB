 ...
 */
public class ShadowDbPBConnection implements DBConnection {
	...
	public ShadowDbPBConnection(String clientId, LinkedList<IdIpPort> allDbs)
		throws Exception {
	...
	public QueryResult submit(AnerisMessage transaction) {
		throw new UnsupportedOperationException("When Aneris is in INTERPRETED mode, only transactions"
			+ " expressed as ShadowTransactions are supported");
	}
}

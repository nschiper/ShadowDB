...
(lambda (nvas)
(lambda (nvbs)
(funcall (funcall (fix "nvlist_ind-1" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(funcall (fix "nvlist_ind-2" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(funcall (fix "nvlist_ind-3" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(defun nvappend (k nvas nvbs)
(funcall (fix (format nil "nvlist_ind-4-~A" k) (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(nvreduce (lambda (nvl)
(lambda (nvl_)
(nvappend 1 (funcall nvl) (funcall nvl_)))) (make-axiom) nvll))
...
(make-pair :fst nvn :snd (nvappend 3 nvmissing (nvfrom-upto (+ nvmax 1) nvn)))
...
(defun nvlength (nvas)
(funcall (fix "nvlist_ind-5" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(funcall (fix "nvlist_ind-6" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(funcall (fix "nvlist_ind-7" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(make-pair :fst (funcall nvslt) :snd (nvappend 4 nvmissing (nvfrom-upto (+ nvmax 1) (funcall nvslt))))
...
(let ((nvcmds (funcall (fix "nvlist_ind-8" (lambda (nvlist_ind)
(lambda (nvL)
(let ((nvv (funcall nvL)))
(if (pair-p nvv)
(let ((pair nvv))
...
(if (inl-p (nvisl nvh))
(make-axiom)
(nvappend 5 (funcall (funcall nvlist_ind)
...
(make-pair :fst nvcid :snd (nvappend 6 nvmissing (nvfrom-upto (+ nvmax 1) nvcid)))

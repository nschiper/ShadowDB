...
(if (inl-p dec)
(let ((nvv1 (funcall (funcall (funcall (nvaneris_pax_v1_scout_output "UNION" nvaccpts (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
(funcall (funcall (nvaneris_pax_v1_mk_bnum)
0)
nvi))
nvi)
...
(let ((dec nvx))
(if (inl-p dec)
(let ((nvv4 (nvappend (funcall (funcall (nvaneris_pax_v1_p1a_broadcast "UNION" (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
nvaccpts)
...
(declare (ignore nvm))
(make-pair :fst (make-inr :val (make-axiom)) :snd (funcall (funcall (nvaneris_pax_v1_p2a_broadcast "UNION" (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
nvaccpts)
...
(if (inl-p dec)
(let ((nvv1 (funcall (funcall (funcall (nvaneris_pax_v1_commander_output "UNION" nvaccpts (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) nvldrs (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvreps nvf)
nvx)
nvi)
nvy)))
...
nvy1)
nvy)))
(let ((nvv3 (nvappend (funcall (funcall (funcall (funcall (nvaneris_23_v1_when_quorum "UNION" (nvaneris_cmd_deq "INT" nvOp (nvint-deq) nveq_Op) 2 nvflrs (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
(make-pair :fst nvn :snd 0))
nvi)
nvy1)
nvy) (make-axiom))))
(let ((dec nvx))
(if (inl-p dec)
(let ((nvv4 (nvappend (funcall (funcall (nvaneris_23_v1_vote_broadcast "UNION" (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
nvlocs)
...
(make-inl :val (lambda (nva)
(let ((nvv (nvbag-union (nvbag-map (lambda (nvx)
(funcall (funcall (funcall (nvaneris_23_v1_decision "UNION" nvreps (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
nvn)
nvi)
nvx)) (let ((pair nva))
(let ((nvx (pair-fst pair))
...
(if (inl-p dec)
(let ((nvv5 (nvmap (funcall (funcall (funcall (nvaneris_v2_out_tr nvOp (make-pair :fst "bcast" :snd (make-axiom)) (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) (make-pair :fst "response" :snd (make-axiom)) (make-pair :fst "swap" :snd (make-axiom)) (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf)
(nvaneris_v2_propose_inr nvOp (make-pair :fst "bcast" :snd (make-axiom)) (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) nvldrs (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) (make-pair :fst "response" :snd (make-axiom)) (make-pair :fst "swap" :snd (make-axiom)) nvlocs (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf))
nvi)
nvy) nvs)))
(let ((dec (nvbag-null nvv5)))
(if (inl-p dec)
...
(error "decide:an_injection_should_be_a_list_with_header_inl_or_inr"))))
(error "decide:an_injection_should_be_a_list_with_header_inl_or_inr")))))))))))
(make-pair :fst (make-pair :fst (make-pair :fst 1 :snd (make-pair :fst (make-inr :val (make-axiom)) :snd (make-pair :fst (make-axiom) :snd (make-pair :fst (make-axiom) :snd (make-pair :fst (make-axiom) :snd (make-pair :fst "2/3" :snd (make-axiom))))))) :snd (make-axiom)) :snd (make-axiom)))
(if (inr-p dec)
(nvhdf-halt)
(error "decide:an_injection_should_be_a_list_with_header_inl_or_inr"))))))))))))))))))

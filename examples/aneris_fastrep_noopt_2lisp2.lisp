...
(defun nvaneris_v2_init_slot_num ()
1)

(defun nvaneris_v2_init_active ()
(nvbfalse))

(defun nvaneris_v2_init_proposals (nvOp)
(declare (ignore nvOp))
(make-axiom))

(defun nvaneris_v2_init_decisions (nvOp)
(declare (ignore nvOp))
(make-axiom))

(defun nvaneris_v2_init_todo (nvOp)
(declare (ignore nvOp))
(make-axiom))

(defun nvaneris_v2_init_protocol ()
(make-pair :fst "2/3" :snd (make-axiom)))

(defun nvaneris_v2_init_state (nvOp)
(make-pair :fst (nvaneris_v2_init_slot_num) :snd (make-pair :fst (nvaneris_v2_init_active) :snd (make-pair :fst (nvaneris_v2_init_proposals nvOp) :snd (make-pair :fst (nvaneris_v2_init_decisions nvOp) :snd (make-pair :fst (nvaneris_v2_init_todo nvOp) :snd (nvaneris_v2_init_protocol)))))))
...
(lambda (nvr)
(funcall (lambda (nvx_)
(if (inl-p (nvlt_int nvx_ nvx))
(nvbfalse)
(nvbor (nveq_int nvx nvx_) nvr)))
(funcall (nvaneris_v2_proposal2num nvOp)
nvprp)))) (nvbfalse) nvdecisions))
(funcall (nvaneris_v2_command_tag2num nvOp)
nvcmdt)))))
...
(lambda (nvp)
(nvbor (nveq_int nvx (funcall (nvaneris_v2_proposal2num nvOp)
nvx_)) nvp))) (nvbfalse) nvtodo))
(funcall (nvaneris_v2_command_tag2num nvOp)
nvcmdt)))))
...
nvcmdt)
nvd) (funcall (funcall (nvaneris_v2_is_todo nvOp)
nvcmdt)
nve)))
...
(funcall (lambda (nvx)
(funcall (lambda (nvx_)
(make-pair :fst (make-pair :fst nva :snd (make-pair :fst (nvbtrue) :snd (make-pair :fst nvx :snd (make-pair :fst nvd :snd (make-pair :fst nve :snd nvf_))))) :snd nvx_))
(if (inl-p nvb)
(make-axiom)
...
(make-pair :fst nva :snd nvcmdt))
(make-axiom))))))
(funcall (funcall (nvaneris_v2_add_proposal_if_not_in nvOp)
nvcmdt)
nvc))))))))))))))))
...
(defun nvaneris_v2_swap_base-program (nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(declare (ignore nvOp))
(declare (ignore nvbcast))
(declare (ignore nvdecision))
(declare (ignore nvpax_propose))
...
(defun nvaneris_v2_bcast_base-program (nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(declare (ignore nvOp))
(declare (ignore nvdecision))
(declare (ignore nvpax_propose))
(declare (ignore nvresponse))
...
(lambda (nvprotocol)
(funcall (lambda (nvx)
(make-pair :fst nvx :snd (funcall (funcall (nvaneris_v2_response_broadcast nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
nvclients)
...
(declare (ignore nvprp1))
(lambda (nvprp2)
nvprp2)) (make-pair :fst nvslt :snd nvcmdt) nvdecisions)))))
...
nvcmdt)
nvd))
(make-pair :fst (make-pair :fst nva :snd (make-pair :fst nvb :snd (make-pair :fst nvc :snd (make-pair :fst nvd :snd (make-pair :fst nvx :snd nvf_))))) :snd (make-axiom))
...
(funcall (lambda (nvx_)
(make-pair :fst (make-pair :fst (+ nva 1) :snd (make-pair :fst (nvbfalse) :snd (make-pair :fst nvc :snd (make-pair :fst nvx_ :snd (make-pair :fst nvx :snd nvprotocol_))))) :snd nvmsgs))
(funcall (funcall (funcall (nvaneris_v2_add_decision nvOp)
nva)
nvcmdt)
nvd))))))
(funcall (funcall (nvaneris_v2_filter_out_todo nvOp)
nva)
nve)))))))))))))))
...
nvcmdt)
(make-pair :fst nva :snd (make-pair :fst nvb :snd (make-pair :fst nvc :snd (make-pair :fst nvd :snd (make-pair :fst nve :snd nvf_))))))
...
(funcall (lambda (nvx)
(nvremove-combine (lambda (nvprp)
(- nvx (funcall (nvaneris_v2_command_tag2cid nvOp)
nvprp))) nvproposals))
(funcall (nvaneris_v2_command_tag2cid nvOp)
nvcmdt)))))
...
(lambda (nvdecisions)
(lambda (nvtodo)
(if (inl-p (nvbor (nvlt_int nvslt nvslot_num) (funcall (funcall (nvaneris_v2_is_decision nvOp)
nvcmdt)
nvdecisions)))
nvtodo
...
(declare (ignore nvprp1))
(lambda (nvprp2)
nvprp2)) (make-pair :fst nvslt :snd nvcmdt) nvtodo))))))))
...
(nvaneris_v2_on_slot_num nvOp nvbcast nvclients nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf))
(make-pair :fst nva :snd (make-pair :fst nvb :snd (make-pair :fst nvx_ :snd (make-pair :fst nvd :snd (make-pair :fst nvx :snd nvf_))))))
nvx)))
(let ((nvz (pair-fst pair))
...
(funcall (funcall (nvaneris_v2_filter_out_proposals nvOp)
nvcmdt)
nvc)))
(funcall (funcall (funcall (funcall (funcall (nvaneris_v2_add_todo nvOp)
nva)
nvslt)
nvcmdt)
nvd)
...
(defun nvaneris_v2_decision_base-program (nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(declare (ignore nvOp))
(declare (ignore nvbcast))
(declare (ignore nvpax_propose))
(declare (ignore nvresponse))
...
(defun nvaneris_v2_ReplicaState-program (nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)
(nvstate-class3-program (lambda (nvz)
(declare (ignore nvz))
(make-pair :fst (nvaneris_v2_init_state nvOp) :snd (make-axiom))) (funcall (nvaneris_v2_out_tr nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(nvaneris_v2_propose_inl nvOp nvbcast nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)) (nvaneris_v2_swap_base-program nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf) (funcall (nvaneris_v2_out_tr nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(nvaneris_v2_propose_inr nvOp nvbcast nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)) (nvaneris_v2_bcast_base-program nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf) (funcall (nvaneris_v2_out_tr nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)
(nvaneris_v2_on_decision nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)) (nvaneris_v2_decision_base-program nvOp nvbcast nvdecision nvpax_propose nvresponse nvswap nvtt_propose nvf)))

(defun nvaneris_v2_Replica-program (nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)
(nveclass0-program (lambda (nvz)
(declare (ignore nvz))
(lambda (nvx)
(nvpi2 nvx))) (nvaneris_v2_ReplicaState-program nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf)))

(defun nvaneris_v2_main-program (nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvreps nvresponse nvswap nvtt_procs nvtt_propose nvf)
(nvclass-at-program (nvaneris_v2_Replica-program nvOp nvbcast nvclients nvdecision nvpax_procs nvpax_propose nvresponse nvswap nvtt_procs nvtt_propose nvf) nvreps))

(defun nvaneris_v2_main-program-inst (nvOp nvclients nvreps nvpax_procs nvtt_procs nvf)
(nvaneris_v2_main-program nvOp (make-pair :fst "bcast" :snd (make-axiom)) nvclients (make-pair :fst "aneris" :snd (make-pair :fst "decision" :snd (make-axiom))) nvpax_procs (make-pair :fst "aneris" :snd (make-pair :fst "pax" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvreps (make-pair :fst "response" :snd (make-axiom)) (make-pair :fst "swap" :snd (make-axiom)) nvtt_procs (make-pair :fst "aneris" :snd (make-pair :fst "23" :snd (make-pair :fst "propose" :snd (make-axiom)))) nvf))

(defun nvaneris_v2_full-program (nvOp nveq_Op nvaccpts nvldrs nvldrs_uid nvlocs nvreps nvclients nvflrs nvf)
(nvparallel-class-program (nvaneris_pax_v1_main-program-inst "INT" nvOp nvaccpts nvldrs nvldrs_uid nvreps nvf) (nvparallel-class-program (nvaneris_23_v1_main-program-inst "INT" nvOp (nvint-deq) nveq_Op nvreps nvflrs nvlocs nvf) (nvaneris_v2_main-program-inst nvOp nvclients nvreps nvldrs nvlocs nvf))))
...
(lambda (nvflrs)
(lambda (nvf)
(nvaneris_v2_full-program nvOp nveq_Op nvaccpts nvldrs nvldrs_uid nvlocs nvreps nvclients nvflrs nvf))))))))))))
